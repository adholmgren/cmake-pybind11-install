...
class CMakeBuild(build_ext):
    ...
    def build_extension(self, ext):
        ...
        # from Python.
        library_path = extdir + "/scikit"
        cmake_args = [
            "-DCMAKE_LIBRARY_OUTPUT_DIRECTORY={}".format(library_path),
...
setup(
    ...
    packages=find_packages(where="scikit_build"),
    package_dir={"": "scikit_build"},
    cmake_install_dir="scikit_build/scikit",
    ext_modules=[CMakeExtension('_scikit_build')],
